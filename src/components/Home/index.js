    ...
    return (
      <>
        <div testid="countryWideConfirmedCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/check-mark_1_rd1jqg.svg"
        ...
        <div testid="countryWideActiveCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/protection_1_h3i7u2.svg"
            className="stats-icon"
        ...
        <div testid="countryWideRecoveredCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/recovered_1_xcr50r.svg"
            className="stats-icon"
        ...
        <div testid="countryWideDeceasedCases" className="stats-block-column ">
          ...
          <img
            src="https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/breathing_1_qvsjgf.svg"
            className="stats-icon"
