...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/check-mark_1_rd1jqg.svg',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/protection_1_h3i7u2.svg',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/recovered_1_xcr50r.svg',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/dyr0qg5sy/image/upload/v1656931771/breathing_1_qvsjgf.svg',
      value: totalDeceased,
    }
